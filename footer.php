					...
					<div class="row">
						<div class="col-xl-3 col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
							<div class="widget widget_about">
								<div style="background-color: white;" class="footer-logo logo-white">
							...
							<div class="widget widget_getintuch">
								...
								<ul>
									<li>
										...
										<span>ABC road, North Nazimabad Karachi, Pakistan</span>
									</li>
									<li>
									...
									<li>
										...
										<span>support@e_books.id<br>
											info@e_books.id</span>
									</li>
								</ul>
							</div>
						</div>
				...
				<div class="container">
					<div class="row fb-inner">
						<div class="col-lg-6 col-md-12 text-start">
							<p class="copyright-text">e-Book Store Ecommerce Website - © 2023 All Rights Reserved</p>
						</div>

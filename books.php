...
if(isset($_GET['id']))
{
	$query = "select * from books where g_id=".$_GET['id'];
		...
		<section class="content-inner-1 border-bottom">
			...
			<div class="col-book style-1">
						<div class="dz-shop-card style-1">
							<div class="dz-media">
							<a href="books-detail.php?id=<?= $row['b_id']; ?>"><img src="admin/<?php echo ($row['b_img']); ?>"
                             alt="User"></a>									
							</div>
							...
							<div class="dz-content">
								<h5 class="title"><a href="books-grid-view.html"><?= $row['b_name']; ?></a></h5>
								<ul class="dz-tags">
									<li><a href="books-grid-view.html"><?= $row['author']; ?></a></li>
								</ul>
								
								<div class="book-footer">
									<div class="price">
										<span class="price-num"><?= $row['b_price']; ?>/=</span>
										
									</div>
									<a href="books-detail.php?id=<?= $row['b_id']; ?>" class="btn btn-secondary box-btn btnhover btnhover2"> Details</a>
								</div>
							</div>
						</div>
					</div>
			...
			{
				echo "<center><h4>No Books in this Category</h4></center>";
			}

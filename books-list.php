				...
				?>
					<div class="col-md-12 col-sm-12">
						<div class="dz-shop-card style-2">
							<div class="dz-media">
							<a href="books-detail.php?id=<?= $row['b_id']; ?>"><img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['b_img']); ?>"
                             alt="User"></a>									
							</div>
							<div class="dz-content">
								<div class="dz-header">
									<div>
										...
										<h4 class="title mb-0"><a href="books-list.html"><?= $row['b_name']; ?></a></h4>
									</div>
									<div class="price">
										<span class="price-num text-primary"><?= $row['b_price']; ?></span>
									</div>
								</div>
								...
								<div class="dz-body">
									<div class="dz-rating-box">
										<div>
											<p class="dz-para"><?= $row['bs_details']; ?></p>
										</div>
									...
									<div class="rate">
										<ul class="book-info">
											<li><span>Writen by</span><?= $row['auther']; ?></li>
